...
from ..exceptions import UnexpectedDeviceResponse, \
    ...
    InvalidParameters, InvalidFenceType, InvalidPolicyType, \
    InvalidPolicyAttributes
...
class AuthPolicy(object):
    ...
    def __init__(self, any=0, knowledge=False, inherence=False,
        ...
        warnings.warn("This object has been deprecated and will be removed in "
                      ...
                      "Please use the new policy objects",
    ...
    def get_policy(self):
        ...
        """
        warnings.warn("This has been deprecated and will be removed in the "
                      "next major version",
                      category=DeprecationWarning)
        return self.to_json()
...
class ConditionalGeoFencePolicy(Policy):
    ...
    def __init__(self, inside, outside, deny_rooted_jailbroken=False,
        ...
        self.__ALLOWED_INNER_POLICIES = ["FACTORS", "METHOD_AMOUNT"]
    ...
    def __create_inner_policies(self, policy):
        if policy.type == "METHOD_AMOUNT":
            ...
            raise InvalidPolicyType(
                ...
                str(self.__ALLOWED_INNER_POLICIES)
            )
